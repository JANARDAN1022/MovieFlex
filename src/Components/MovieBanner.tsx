  ...
  return Movie ? (
    <div className="relative h-full min-h-[300px] md:min-h-[600px] md:max-h-[700px] ">
      ...
      <div className="absolute top-[50%] sm:top-[40%] md:top-[30%] ml-4 md:ml-16">
        ...
        <div className="flex flex-row mt-3 md:mt-10 gap-3 ">
          <button
            ...
            className={`${
              showInfo ? "" : "hover:bg-opacity-100"
            } flex bg-white  bg-opacity-70  w-24 h-[25px] md:w-44 md:h-[50px] rounded-[3px] justify-center items-center gap-2 p-2 text-xs lg:text-[20px]`}
          >
          ...
          <button
            ...
            className={`${
              showInfo ? "" : "hover:bg-opacity-20"
            } flex bg-zinc-400 text-white bg-opacity-30 w-32 h-[25px] md:w-44 md:h-[50px] rounded-[3px] justify-center items-center gap-0 md:gap-2 p-2 text-xs lg:text-[20px] `}
          >
      ...
      <div
        ...
        } absolute top-20 md:top-36 left-0 md:left-[8%] lg:left-[20%] min-[1173px]:left-[25%] w-full  md:max-w-2xl lg:max-w-3xl h-max  z-[9999] `}
      >
        <video
          className="
    ...
    "
        ...
        <MdOutlineCancel
          size={50}
          className="cursor-pointer text-white absolute z-20 top-0 right-3"
          onClick={() => {
            setshowInfo(false);
          }}
        />
        <span className="bg-black rounded-md py-1 px-4 text-xs absolute bottom-2 sm:bottom-5 right-5 text-white  ">
    ...
    flex flex-col h-max z-50
      "
        >
          <div
            onClick={() => Navigate(`/watch/${Movie.name}`)}
            className="flex flex-row items-center absolute top-[-40px] sm:top-[-60px] md:top-[-70px] left-5  gap-5 "
          >
            <div
              className="
   ...
   "
          ...
          <div className="flex flex-row justify-center mt-4 gap-2 items-center">
            <p className="text-white font-bold text-sm sm:text-base lg:text-2xl">
              {Movie.name}
            </p>
          </div>
